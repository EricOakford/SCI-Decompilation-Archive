...
(instance rm23 of SQRoom
	...
	(method (init)
		(if (== currentFloor 2)
			...
			(LoadMany 128 14 123 423 328)
			(LoadMany 132 408 407)
		)
		(switch prevRoomNum
		...
		(if (not (Btst 57)) (pod init: stopUpd:))
	)
...
(instance pod of Actor
	...
	(method (init)
		(super init: &rest)
		(cond 
			((and (== currentFloor 1) (not (Btst 56)))
				(self approachVerbs: 3 12)
				(= approachX 97)
				(= approachY 63)
			)
			((and (== currentFloor 2) (Btst 56))
				(self approachVerbs: 12)
				(= approachX 101)
				(= approachY 153)
			)
		)
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2
				(if (Btst 56) (Print 23 5) else (Print 23 6))
			)
			(3
				(cond 
					((Btst 56) (Print 23 7))
