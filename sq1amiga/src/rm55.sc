...
(instance rm55 of Rm
	...
	(method (init)
		...
		(if (OneOf local49 1 2)
			...
			(if
				(or
					(and (== local49 1) (Btst 36))
					(and (== local49 2) (Btst 37))
				)
...
code_030f:
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(ego setCycle: Fwd setMotion: PolyPath 223 133 self)
			)
			(2
...
(instance toGrate of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(LoadMany 132 529 509)
				(Print 55 3)
				(SolvePuzzle 3 163)
				(ego setLoop: 11 posn: 244 149 cel: 0 setCycle: End self)
			)
			(1
...
code_0d16:
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(ego
					setCycle: (if (== (ego loop?) 1) Rev else Fwd)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(ego setStep: 1 4)
				(if (ego loop?)
					(ego setCycle: Fwd setMotion: MoveTo 172 109 self)
				else
					(ego setCycle: Rev setMotion: MoveTo 160 106 self)
				)
			)
			(1
				(if (ego loop?)
					...
					(ego setLoop: 9 cel: 6 setCycle: Beg self)
				)
			)
			(2
...
(instance ontoLadderFromBottom of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(ego posn: 159 141 setLoop: 4 cel: 0 setCycle: End self)
			)
			(3
				(ego setLoop: 4 cel: 0 posn: 158 121)
				(HandsOn)
...
(instance ontoLadderFromTopBackwards of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(ego setLoop: 4 cel: 1 posn: 160 104 setCycle: Beg self)
			)
			(3
				(ego
					posn: 158 121
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				((curRoom obstacles?) delete: upperPoly)
				(ego setCycle: Fwd setMotion: MoveTo 164 52 self)
			)
			(1
				(ego setLoop: 5 cel: 8 posn: 164 52 setCycle: CT 4 1 self)
			)
			(2
				(ego setLoop: 7 cel: 7 posn: 168 57 setCycle: Beg self)
			)
			(3
				(ego setLoop: 4 cel: 1 posn: 160 104 setCycle: Beg self)
			)
...
(instance crawlHigh of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(ego cel: 0 posn: 160 104 setCycle: CT 1 1 self)
			)
			(2
				(ego setLoop: 7 cel: 0 posn: 170 56 setCycle: End self)
			)
			(3
				(ego
					setLoop: 2
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(ego posn: 159 141 setLoop: 4 cel: 4 setCycle: Beg self)
			)
			(1
				(ego posn: 155 147 setLoop: 5 cel: 0 setCycle: End self)
			)
			(2
				(ego
					setLoop: 1
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(ego posn: 161 108 setLoop: 9 cel: 0 setCycle: End self)
			)
			(1
				(ego
					setLoop: 0
...
(instance vent of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3
				(if (and (== cel 0) (& (ego onControl: 1) $0008))
