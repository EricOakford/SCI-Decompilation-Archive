...
(instance rm61 of SQRoom
	...
	(method (init)
		...
		(self setRegions: 703)
		(LoadMany 128 66 161)
		(if (ego has: 0) (LoadMany 132 413 5 312))
		(features
	...
	(method (doit &tmp temp0)
		(cond 
			...
			((& (= temp0 (ego onControl: 1)) $0002) (self setScript: toSlantway))
			((& temp0 $0004) (self setScript: toElevatorRm))
			((& temp0 $0008) (self setScript: toStorageRm))
		)
		(super doit:)
	)
)
...
(instance fromSlantway of DScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(ego ignoreActors: 0 setLoop: -1 setPri: -1)
				(HandsOn)
				(self dispose:)
			)
		)
...
(instance bigMach of RegionFeature
	...
	(method (doVerb theVerb theItem)
		(switch theVerb
			...
			(4
				(if (and (== theItem 0) (== currentFloor 2))
