...
(instance rm58 of SQRoom
	...
	(method (init)
		(self setRegions: 703)
		(= currentFloor 2)
		(LoadMany 128 158 40 91 460 519 76 67 461)
		(LoadMany 131 158)
		(LoadMany 132 524 523)
		(HandsOff)
		(= local1 1)
		...
		(switch theVerb
			...
			(4
				(cond 
					...
					((== theItem 12) (curRoom setScript: warnEgo))
					(else (Print 58 6))
				)
			)
			(else 
...
(instance shootEgo1 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(droidWalkSound stop:)
				(= saveBits (Graph grSAVE_BOX 86 0 189 209 1))
				(= ticks 18)
			)
			(4
				(ego stopUpd:)
			...
			(6
				...
				(ego view: 67 loop: 0 cel: 0 setCycle: End self)
			)
			(7
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(ego startUpd:)
				(soundFx number: 368 loop: 1 play:)
				(ego view: 67 loop: 2 cel: 0 setCycle: End self)
			)
			(8
				(Graph grRESTORE_BOX saveBits)
				(Graph grUPDATE_BOX 86 0 189 209 1)
...
(instance egoShowsCard of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(ego view: 91 loop: 0 cel: 0 setCycle: End self)
			)
			(2
				(droidWalkSound number: 523 loop: -1 flags: 1 play:)
				(DeltaurRegion
