...
(local
	...
	[trunkBackPts 36] = [84 147 50 159 73 175 108 160 131 176 174 178 221 162 268 189 0 189 0 0 319 0 319 189 129 95 110 100 132 110 91 121 74 113 38 121]
)
(instance rm54 of SQRoom
	...
	(method (init)
		...
		(HandsOff)
		(= currentFloor 2)
		(LoadMany 128 154 37 39 51 36 1 61 2)
		(LoadMany 132 514 526 512 513 515 538)
		(ego init:)
		(vent init:)
		(roomWithTrunkForwardPoly
			points: @trunkForwardPts
			size: 27
		)
		(trunkPoly points: @trunkPts size: 4)
		(roomWithTrunkBackPoly points: @trunkBackPts size: 18)
		(if (or (Btst 62) (Btst 29))
	...
	(method (doit)
		...
		(cond 
			...
			((& (ego onControl: 0) $0002) (self setScript: toHall))
		)
	)
	...
	(method (doVerb theVerb)
		(if (== theVerb 2)
			(if
			(or (Btst 29) (== (DeltaurRegion egoStatus?) 1))
				(Print 54 0)
			else
				(Print 54 1)
			)
...
(instance vent of Prop
	...
	(method (init)
		(super init: &rest)
		(if (Btst 36) (self setCel: (self lastCel:)))
		(self stopUpd:)
	)
			...
			(4
				(if (== theItem 4)
					(cond 
						...
						((or (Btst 29) (Btst 62)) (Print 54 4))
						((not (not (vent cel?))) (Print 54 5))
						((Btst 34) (Print 54 6))
						((not (Btst 35)) (curRoom setScript: cantReachIt))
...
(instance trunk of Prop
	...
	(method (init)
		(super init: &rest)
		(if (Btst 29) (Bclr 34))
		(if (Btst 34) (self cel: (self lastCel:)))
		(if (Btst 35)
			(= x 104)
			(= y 115)
		else
	...
	(method (doVerb theVerb theItem)
		(if (not (Btst 29))
			(switch theVerb
				...
				(3
					(cond 
						((Btst 34) (curRoom setScript: egoClimbInTrunk))
						((not (Btst 35)) (curRoom setScript: pushTheTrunkScript))
						(else (Print 54 7))
					)
				)
				(2
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(guard setScript: 0)
				(= local0 0)
				(ego ignoreActors: 1 setMotion: MoveTo 267 177 self)
			)
...
(instance closeTrunkScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(ego setLoop: 5 x: (trunk x?) cel: 2 setCycle: Beg self)
			)
			(4
