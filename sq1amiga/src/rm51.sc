...
(procedure (localproc_0164 param1 param2 param3 param4 param5 &tmp temp0 temp1 temp2 temp3)
	...
	(= saveBits (Graph grSAVE_BOX temp0 temp1 temp2 temp3 1))
	(Graph
		grDRAW_LINE
		param2
		param1
...
(instance rm51 of SQRoom
	...
	(method (init)
		(LoadMany 128 34 64 152 82 83 151 54)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(ego cycleSpeed: 9 setCycle: End self)
				(= state 8)
			)
			(5
				(ego
			...
			(8
				...
				(ego cycleSpeed: 14 moveSpeed: 8 setCycle: End self)
			)
			(9 (officer setCycle: Beg self))
			(10 (self dispose:))
		)
	)
)
...
(instance goInside of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(cond 
					((== (ego loop?) 1) (ego view: 64 setLoop: 1 cel: 0 setCycle: End self))
					((== (ego loop?) 3) (ego view: 64 setLoop: 4 cel: 0 setCycle: End self))
					(else (= cycles 3))
				)
			)
			(3
				(if (or (== (ego loop?) 1) (== (ego loop?) 2))
					(ego view: 64 setLoop: 2 cel: 0 setCycle: End self)
				else
					(= cycles 3)
				)
			)
			...
			(5
				...
				(ego cel: 2 setCycle: CT 6 1 self)
			)
			(6
				(door cel: 1 forceUpd:)
				(ego cel: 2 setCycle: CT 6 1 self)
			...
			(11
				...
				(ego setLoop: 11 setCycle: End self)
			)
			(12
				(theMusic fade:)
				(ego
