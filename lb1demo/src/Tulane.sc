...
(instance LaurasLegs of PicView
	(properties
		y 168
		x 106
		view 178
...
(instance Tulane of Room
	...
	(method (init)
		...
		(Load FONT 40)
		(Load FONT 41)
		(addToPics add: bench statue LaurasLegs doit:)
		(LaurasHead
			view: 178
			loop: 1
			cel: 0
...
(instance campusLife of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(squirrel startUpd:)
				(Display 779 2 p_restore saveBits2)
				(Display 779 2 p_restore saveBits)
				(Lillian
					view: 513
					setLoop: 0
					cel: 7
