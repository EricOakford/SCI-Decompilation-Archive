	...
	(method (doit)
		...
		(if (and (== state 4) (> local6 -1))
			(if (== (mod local6 2) 1)
				...
				(if (== local6 4)
					(Thunder number: 17 loop: 1 play: self)
				)
				(Door cel: 1)
				(Jeeves cel: 1)
				(light1 cel: 1)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				...
				(Print 783 2 #at 105 30 #mode 1 #draw #dispose)
				(= seconds 2)
			)
			(7
				(Mouth setCycle: 0 cel: 0)
				(cls)
				(Print 783 3 #at 105 140 #draw #dispose)
				(= seconds 5)
			)
			(8
				(cls)
				(Print 783 4 #at 105 30 #mode 1 #draw #dispose)
				(= local4 2)
			...
			(9
				(cls)
				(Print 783 5 #at 63 30 #mode 1 #draw #dispose)
				(= local4 5)
				(Mouth setScript: mouthCyc)
				(= seconds 5)
			)
			(10
				(cls)
				(Print 783 6 #at 78 30 #mode 1 #draw #dispose)
				(= local4 6)
				(Mouth setScript: mouthCyc)
				(= seconds 5)
			)
			(11
				(cls)
				(Print 783 7 #at 75 30 #mode 1 #draw #dispose)
				(= local4 6)
				(Mouth setScript: mouthCyc)
				(= seconds 5)
			)
