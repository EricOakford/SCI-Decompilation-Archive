...
(instance rm29 of Room
	...
	(method (init)
		...
		(switch prevRoomNum
			(north
				(ego
					posn: (proc0_17 319 (proc0_18 258 (ego x?) 148) 89) (+ horizon 2)
				)
			)
			(south
				(ego posn: (proc0_17 319 (ego x?) 30) 188)
			)
			(west
				(ego posn: 3 (proc0_17 188 (ego y?) (+ 2 horizon)))
			)
			(east
		...
		(rock4 init:)
		(rock5 init:)
		(if (and (not (Btst fGoatFollows)) (Random 0 6))
