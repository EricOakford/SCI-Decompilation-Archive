				...
				(switch param6
					(0
						(if param3
							(switch (mod param2 3)
								(0
									(temp0 loop: 2 cel: 2 x: 173 y: 167 noun: 46)
									(curRoom
										addObstacle:
											((Polygon new:)
												type: 2
								...
								(1
									(temp0 loop: 2 cel: 2 x: 217 y: 127 noun: 47)
									(curRoom
										addObstacle:
											((Polygon new:)
												type: 2
							...
							(switch (mod param2 3)
								(0
									(temp0 loop: 2 cel: 2 x: 146 y: 167 noun: 49)
									(curRoom
										addObstacle:
											((Polygon new:)
												type: 2
								...
								(1
									(temp0 loop: 2 cel: 1 x: 102 y: 127 noun: 50)
									(curRoom
										addObstacle:
											((Polygon new:)
												type: 2
						...
						(if param3
							...
							(switch (mod param2 3)
								(0
									...
									(curRoom
										addObstacle: ((Polygon new:) type: 2 init: 0 55 15 65 0 75 yourself:)
									)
								)
								(1
									(temp0
						...
						(if param3
							...
							(switch (mod param2 3)
								...
								(2
									...
									(curRoom
										addObstacle: ((Polygon new:) type: 2 init: 0 55 12 65 0 75 yourself:)
									)
								)
							)
						)
