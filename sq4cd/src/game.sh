...
(include "900.shm")	;death messages
...
(enum
	...
	fRadioShockClosed			;12	;EO: While it's renamed to Hz. So Good in the CD version,
									; I'm using the original name here for consistency reasons
