	...
	(method (init)
		...
		(switch curTalker
			...
			(25
				(switch global142
					(0
						(if (and (== eurekaCurLocation 5) (Btst 93))
							(systemWindow tailY: 100)
						)
						(self view: 209 loop: 0 cel: 0)
						(quirkEyes view: 209 loop: 2 cel: 0 nsLeft: 37 nsTop: 16)
						(quirkMouth view: 209 loop: 1 cel: 0 nsLeft: 37 nsTop: 39)
					)
					(1
						(self view: 210 loop: 0 cel: 0)
						(quirkEyes view: 210 loop: 3 cel: 0 nsLeft: 32 nsTop: 25)
						(quirkMouth view: 210 loop: 1 cel: 0 nsLeft: 33 nsTop: 43)
					)
					(2
						(self view: 204 loop: 0 cel: 0)
						(quirkEyes view: 204 loop: 2 cel: 0 nsLeft: 22 nsTop: 11)
						(quirkMouth view: 204 loop: 1 cel: 0 nsLeft: 23 nsTop: 29)
					)
				)
