	...
	(method (changeState newState &tmp theX theY)
		(switch (= state newState)
			...
			(17
				...
				(= theX (FindLanguage 116 116 116 116 116))
				(= theY (FindLanguage 74 74 74 74 74))
				(Display
					@str1
					p_at
					theX
				...
				(= theX (FindLanguage 163 136 136 136 136))
				(= theY (FindLanguage 76 74 76 74 74))
			...
			(18
				...
				(= theX (FindLanguage 116 116 116 116 116))
				(= theY (FindLanguage 84 84 84 84 84))
				(Display
					@str1
					p_at
					theX
				...
				(= theX (FindLanguage 163 186 163 186 186))
				(= theY (FindLanguage 84 84 84 84 84))
				(Display
					@str2
					p_at
			...
			(19
				...
				(= theX (FindLanguage 116 116 116 116 116))
				(= theY (FindLanguage 94 94 94 94 94))
			...
			(20
				...
				(= theX (FindLanguage 163 173 173 173 173))
				(= theY (FindLanguage 94 94 94 94 94))
				(Display @str1 p_at theX theY p_font 10 p_color 19)
				(= ticks 20)
			)
			(21
				(= theX (FindLanguage 163 173 163 173 173))
				(= theY (FindLanguage 94 94 94 94 94))
			...
			(25
				...
				(= theX (FindLanguage 116 116 116 116 116))
				(= theY (FindLanguage 104 104 104 104 104))
				(Display @str2 p_at theX theY p_font 10 p_color 5)
			...
			(31
				...
				(= theX (FindLanguage 116 116 116 116 116))
				(= theY (FindLanguage 114 114 114 114 114))
				(Display @str2 p_at theX theY p_font 10 p_color 5)
				(= ticks 40)
			)
			(32
