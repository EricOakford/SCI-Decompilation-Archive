...
(instance sGo of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0 (= seconds 3))
			(1
				(theMusic2 number: 161 setLoop: -1 play: 80)
			...
			(14
				(rogHead setCel: 0)
				(egoHead init: setPri: 15 setCycle: EndLoop self)
			)
			(15 (= cycles 5))
			(16
				(egoHead setCycle: BegLoop self)
			)
			(17
				(rogHead setCel: 1)
				(= cycles 2)
			...
			(18
				(rogHead dispose:)
				(outline setCycle: EndLoop)
				(= cycles 1)
			)
			(19
				(egoHead dispose:)
				(outline dispose:)
				(eyess init: cycleSpeed: 10 setCycle: EndLoop self)
			)
			(20
				(eyess setCycle: BegLoop self)
			...
			(24
				(Palette PALIntensity 238 239 0)
				(theMusic2 number: 162 setLoop: 1 play:)
				(= seconds 2)
				(= saveBits (Graph GSaveBits 0 65 96 320 1))
			)
			(25
...
(instance egoHead of Prop
	...
	(method (setCycle cType)
		(if cType (theMusic4 number: 160 setLoop: 1 play:))
