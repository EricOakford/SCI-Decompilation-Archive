...
(instance sFryRat of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(theGame handsOff:)
				(theMusic2 number: 142 setLoop: 1 play:)
				(= cycles 6)
			)
			(1
				(rat init:)
			...
			(29
				...
				(shine2 init:)
				(shine3 init:)
				(Palette PALLoad 322 2)
				(= cycles 1)
			)
			(30
				(theMusic2 number: 146 setLoop: 1 play:)
				(shine1 hide:)
				(shine2 hide:)
				(shine3 hide:)
				(Palette PALLoad 32 2)
				(= ticks 5)
			)
			(31
				(shine1 show:)
			...
			(32
				...
				(shine3 dispose:)
				(theMusic2 stop:)
				(Bset fSawMouseInHall)
				(= cycles 1)
			)
			(33 (curRoom newRoom: 127))
		)
	)
)
