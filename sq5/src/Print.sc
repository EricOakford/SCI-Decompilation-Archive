...
;;;		addColorButton	;Add a colored button (specific to SQ5)
...
;;;	)
	...
	;EO: This method is specific to SQ5
	(method (addColorButton val args &tmp
			noun verb case seq theX theY module theText s nfc nbc hfc hbc sfc sbc)
