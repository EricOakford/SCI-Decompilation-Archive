...
(instance sysLogger of Code
	...
	(method (doit 
		...
		(= str 				(String new: 80))
		(= cfgPath 			(String new: 80))
		(= thePath 			(String new: 80))
		(= theToken  		(String new: 80))
		(= QAinitials 		(String new: 80))
...
;		)
		...
		(if (== -1 logHandle)
			...
			; If we don't get rid of this string, we do not
			; get another chance to input the path.
			(sysLogPath dispose:)
		else
