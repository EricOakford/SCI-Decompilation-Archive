...
(class Plane of Object
	...
	(method (dispose)
		...
		(nScreenSizeX dispose:)
		(= casts (= bitmap (= nScreenSizeX 0)))
		(planes delete: self)
	...
	(method (forceCursor param1 &tmp temp0 temp1 temp2 temp3)
		(= temp0 0)
	...
	(method (nScreenOrgX param1 &tmp temp0 temp1)
		(= temp1 0)
		(while (< temp1 argc)
			(= temp0 [param1 temp1])
			(cond 
				((temp0 isKindOf: View) (temp0 init: (self nSpeed:)))
