...
(instance Room46 of Room
	...
	(method (doit)
		...
		(if (& (ego onControl: 0) cLBLUE)
			(ego setPri: 4)
		)
		(if (& (ego onControl: 0) cRED)
			(if (and (== currentStatus egoOnStairs) (== (ego script?) 0))
			...
			(cond 
				...
				((== (event type?) saidEvent)
					(cond 
						...
						((or (Said 'kiss/fairies[<little]') (Said 'kiss[/noword]'))
							(Print 46 14)
						)
