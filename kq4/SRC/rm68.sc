...
(instance Room68 of Room
	...
	(method (doit)
		(if (& (= doorway (ego onControl: FALSE)) $0040)
		...
		(if (and (& doorway $0400) (!= currentStatus egoOnStairs))
			...
			(cond 
				...
				((== (event type?) saidEvent)
					(cond 
						...
						((Said 'look>')
							(cond 
								((Said '<behind/painting') (Print 68 2))
								((Said '/painting') (Print 68 3))
								((Said '/mirror')
								...
								((Said '/chandelier') (Print 68 5))
								((Said '/stair') (Print 68 6))
								((Said '<in/clock') (Print 68 7))
								((Said '/clock') (Print 68 8))
								((Said '/door') (Print 68 9))
								((Said '/wall') (Print 68 10))
								((or (Said '/dirt') (Said '<down')) (Print 68 11))
								((Said '/carpet') (Print 68 12))
								((Said '/table') (Print 68 13))
							)
						)
						((Said 'wind/clock') (Print 68 14))
						((Said 'get/clock') (Print 68 15))
						((Said 'open/clock') (Print 68 7))
						((Said 'get/carpet') (Print 68 16))
						((Said 'get/painting') (Print 68 17))
					)
				)
			)
		)
