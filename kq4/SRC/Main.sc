		...
		(return
			(if (== (event type?) saidEvent)
				...
				(cond 
					...
					(else
						(if (and (ego has: iFish) (Said '/fish>'))
							(cond
								((Said 'smell')
									(Print 0 39)
								)
						...
						(cond 
							...
							((Said 'wear,(put<on)/crown')
								(cond 
									...
									((and (HaveMem CrownSize) (SetEgoView))
										(= oldEgoScript (ego script?))
							...
							((Said 'play/flute')
								(cond 
									...
									((and (SetEgoView) (HaveMem InstrumentSize))
										(= oldEgoScript (ego script?))
								...
								(if (and (ego has: iToyHorse) (Said 'play/horse'))
									...
									(cond 
										...
										(else
											...
											(if (and (ego has: iGlassEye) (Said '/eye>'))
											...
											(cond 
												((and (ego has: iScarab) (Said 'wear,put/charm'))
													(Print 0 71)
												)
												((Said 'hop')
													(Print 0 34)
