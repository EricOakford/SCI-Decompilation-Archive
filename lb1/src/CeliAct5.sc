...
(instance CeliAct5 of Script
	...
	(method (handleEvent event &tmp temp0 temp1 i temp3 [temp4 50])
		(cond 
			((event claimed?))
			((and (== (event type?) saidEvent) global212)
				(= local0 -1)
				(= i [local295 (- global212 1)])
				(while (< i [local295 global212])
				...
				(if (!= local0 -1)
					...
					(cond 
						...
						((and (== local0 51) (& deadGuests $0001)) (= temp3 96))
						((and (== local0 64) (& deadGuests $0002)) (= temp3 97))
						((and (== local0 52) (& deadGuests $0004)) (= temp3 98))
						((and (== local0 49) (& deadGuests $0008)) (= temp3 99))
						(else (= temp3 0))
					)
					(if temp3
