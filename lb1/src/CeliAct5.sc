	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3 [temp4 50])
		(cond 
			...
			((and (== (event type?) evSAID) global212)
				...
				(while (< temp2 [local295 global212])
				...
				(if (!= local0 -1)
					...
					(cond 
						...
						((and (== local0 51) (& global123 $0001)) (= temp3 96))
						((and (== local0 64) (& global123 $0002)) (= temp3 97))
						((and (== local0 52) (& global123 $0004)) (= temp3 98))
						((and (== local0 49) (& global123 $0008)) (= temp3 99))
						(else (= temp3 0))
					)
					(if temp3
