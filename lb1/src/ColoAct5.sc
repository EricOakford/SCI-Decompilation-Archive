	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3)
		(cond 
			...
			((and (== (event type?) evSAID) global212)
				...
				(while (< temp2 [local286 global212])
				...
				(if (!= local0 -1)
					(= temp1 (<< local0 $0001))
					(cond 
						((and (== local0 51) (& global123 $0001)) (= temp3 92))
						((and (== local0 64) (& global123 $0002)) (= temp3 93))
						((and (== local0 52) (& global123 $0004)) (= temp3 95))
						((and (== local0 49) (& global123 $0008)) (= temp3 94))
						(else (= temp3 0))
					)
					(if temp3
