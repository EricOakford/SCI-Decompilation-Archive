...
(local
	[theGJeevesX 36] = [0 0 0 0 100 174 167 163 205 163 260 130 0 0 0 0 260 130 70 170 0 0 0 0 114 124 80 170 20 47 100 168]
	[local36 36] = [0 0 0 0 -20 140 340 163 340 163 340 130 0 0 140 125 140 125 140 240 0 0 0 0 111 124 -20 170 -40 47 -20 168]
	[local72 36] = [0 0 0 0 -20 176 -20 161 -20 150 154 144 0 0 0 0 303 101 0 0 0 0 0 0 0 0 340 175 80 47 340 168]
	...
	[local140 8] = [66 143 64 174 -20 174 -32768]
)
		...
		(switch (= state newState)
			(0
				...
				(if (== [local72 (* global155 2)] 0)
					(cond 
						((and (== curRoomNum 9) (== global155 9)) (Jeeves setMotion: room9a self))
						((and (== curRoomNum 9) (== global155 12)) (Jeeves setMotion: room9b self))
						((== curRoomNum 23) (Jeeves setMotion: room23 self))
					)
				else
					(Jeeves
						setMotion:
			...
			(1
				(if (== global155 5)
					(if (== (gDoor cel?) 0)
						(HandsOff)
						(gDoor cycleSpeed: 3 setCycle: End self)
			...
			(3
				(gDoor cycleSpeed: 3 setCycle: Beg self)
				(gMySound number: 107 play:)
			)
			(4
				(++ global155)
...
(instance Jeeves of Act
	...
	(method (handleEvent event)
		...
		(cond 
			...
			((Said 'flirt//butler<with') (Print 381 2))
			((Said 'ask,tell//*<about') (Print 381 3))
			((Said 'hold,deliver/*')
			...
			((Said '/butler>')
				(cond 
					((Said 'converse') (Print 381 3))
					((Said 'get') (Print 381 5))
					((Said 'kill') (Print 381 6))
					((Said 'kiss') (Print 381 7))
					((Said 'embrace') (Print 381 8))
				)
			)
		)
	)
