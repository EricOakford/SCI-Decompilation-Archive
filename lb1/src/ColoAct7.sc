		...
		(cond 
			...
			((and (== (event type?) evSAID) global212)
				...
				(if (!= local0 -1)
					(= temp1 (<< local0 $0001))
					(cond 
						((and (== local0 52) (& global123 $0001)) (= temp3 98))
						((and (== local0 65) (& global123 $0002)) (= temp3 102))
						((and (== local0 53) (& global123 $0004)) (= temp3 99))
						((and (== local0 50) (& global123 $0008)) (= temp3 96))
						(
							(and
						...
						((and (== local0 45) (& global123 $0020)) (= temp3 95))
						(else (= temp3 0))
					)
					(if temp3
