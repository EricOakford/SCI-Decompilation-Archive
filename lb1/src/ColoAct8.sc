	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3)
		(cond 
			...
			((and (== (event type?) evSAID) global212)
				...
				(while (< temp2 [local294 global212])
				...
				(if (!= local0 -1)
					(= temp1 (<< local0 $0001))
					(cond 
						((and (== local0 50) (& global123 $0001)) (= temp3 96))
						((and (== local0 63) (& global123 $0002)) (= temp3 99))
						((and (== local0 51) (& global123 $0004)) (= temp3 94))
						((and (== local0 48) (& global123 $0008)) (= temp3 93))
						(
							(and
						...
						((and (== local0 43) (& global123 $0020)) (= temp3 92))
						(else (= temp3 0))
					)
					(if temp3
