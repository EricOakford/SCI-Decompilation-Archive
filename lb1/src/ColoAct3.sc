	...
	(method (handleEvent event &tmp temp0 temp1 i temp3)
		(cond 
			...
			((and (== (event type?) saidEvent) global212)
				(= local0 -1)
				(= i [local264 (- global212 1)])
				(while (< i [local264 global212])
				...
				(if (!= local0 -1)
					(= temp1 (<< local0 $0001))
					(cond 
						((and (== local0 50) (& deadGuests $0001)) (= temp3 86))
						((and (== local0 63) (& deadGuests $0002)) (= temp3 87))
						(else (= temp3 0))
					)
					(if temp3
