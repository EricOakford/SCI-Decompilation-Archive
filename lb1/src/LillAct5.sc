	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3)
		(cond 
			...
			((and (== (event type?) saidEvent) global212)
				...
				(while (< temp2 [local277 global212])
				...
				(if (!= local0 -1)
					(= temp1 (<< local0 $0001))
					(cond 
						((and (== local0 52) (& deadGuests $0001)) (= temp3 90))
						((and (== local0 62) (& deadGuests $0002)) (= temp3 92))
						((and (== local0 53) (& deadGuests $0004)) (= temp3 91))
						((and (== local0 50) (& deadGuests $0008)) (= temp3 89))
						(else (= temp3 0))
					)
					(if temp3
