...
(local
	...
	local181 = [8256 10240 8320 8196 2 9216 0 512 528 8 16 1 4 1024 1040 32 34 40 12288 256 260 272 16385 8208 128 8200 16388 8194 16392 16400 16416 16448 16512 544 8256 10240 8320 8196 2 9216 512 528 8 16 1 4 1024 1040 32 34 40 12288 256 272 260 0 16385 8208 128 8200 16388 8194 16392 16400 16416 16448 16512 544 8196 9216 12288 8208 8194 16392 8196 9216 12288 8208 8194 16392 64 64 64 64 64 64 -1]
	local268 = [0 34 68 74 80]
	local273 =  81
	local274 = [82 83 84 85 86]
)
	...
	(method (handleEvent event &tmp temp0 temp1 i temp3)
		(cond 
			...
			((and (== (event type?) saidEvent) global212)
				(= local0 -1)
				(= i [local268 (- global212 1)])
				(while (< i [local268 global212])
					(if (== global211 [local181 i])
						(= local0 i)
						(break)
					)
					(++ i)
				...
				(if (!= local0 -1)
					(= temp1 (<< local0 $0001))
					(cond 
						((and (== local0 44) (& deadGuests $0001)) (= temp3 87))
						((and (== local0 58) (& deadGuests $0002)) (= temp3 89))
						((and (== local0 45) (& deadGuests $0004)) (= temp3 88))
						((and (== local0 42) (& deadGuests $0008)) (= temp3 86))
						(else (= temp3 0))
					)
					(if temp3
