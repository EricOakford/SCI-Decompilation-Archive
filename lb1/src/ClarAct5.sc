	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3)
		(cond 
			...
			((and (== (event type?) evSAID) global212)
				...
				(while (< temp2 [local268 global212])
				...
				(if (!= local0 -1)
					(= temp1 (<< local0 $0001))
					(cond 
						((and (== local0 44) (& global123 $0001)) (= temp3 87))
						((and (== local0 58) (& global123 $0002)) (= temp3 89))
						((and (== local0 45) (& global123 $0004)) (= temp3 88))
						((and (== local0 42) (& global123 $0008)) (= temp3 86))
						(else (= temp3 0))
					)
					(if temp3
