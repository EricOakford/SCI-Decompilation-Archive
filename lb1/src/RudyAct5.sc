	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3)
		(cond 
			...
			((and (== (event type?) saidEvent) global212)
				...
				(while (< temp2 [local289 global212])
				...
				(if (!= local0 -1)
					(= temp1 (<< local0 $0001))
					(cond 
						((and (== local0 51) (& deadGuests $0008)) (= temp3 93))
						((and (== local0 64) (& deadGuests $0002)) (= temp3 94))
						((and (== local0 54) (& deadGuests $0004)) (= temp3 95))
						((and (== local0 53) (& deadGuests $0001)) (= temp3 96))
						(else (= temp3 0))
					)
					(if temp3
