...
(instance rm115Script of Script
	...
	(method (doit)
		(super doit:)
		(if (& (ego onControl:) $0002) (curRoom newRoom: 15))
	)
	...
	(method (handleEvent event)
		...
		(if (Said 'look>')
			(cond 
				((Said '/amp') (Print 115 0))
				((Said '/buffet') (Print 115 1))
				((Said '/carpet') (Print 115 2))
				((Said '/door') (Print 115 3) (Print 115 4))
				((Said '/carpet') (Print 115 5))
				((Said '/agent,children,bimbo')
					(aBigClerk posn: 273 58 stopUpd:)
					(Timer setReal: aBigClerk 5)
					(HandsOff)
				)
				((Said '[/airport,building,rack,rack,new,music]') (Print 115 6) (Print 115 7 #at -1 152))
			)
		)
		(if (Said 'apply,get,play/amp') (Print 115 8))
		(if (Said 'buy')
