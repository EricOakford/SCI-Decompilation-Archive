...
(instance rm375 of Room
	...
	(method (newRoom newRoomNumber)
		(soundFX fade:)
		(if (InRoom iTowel 375) (ego get: iTowel) (Print 375 0))
	...
	(method (handleEvent event)
		...
		(cond 
			...
			(Said 'cease,(drag<off)/bath,faucet,channel,handle,water')
				(cond 
					((not (Btst fShowerOn)) (ItIs))
					((not (& (ego onControl:) cBLUE)) (Print 375 3))
					(else
						(Ok)
			...
			((Said 'rinse')
				(cond 
					((not (Btst fShowerOn)) (Print 375 4))
					((not (& (ego onControl:) cGREEN)) (Print 375 5))
					(else (Ok) (Print 375 6))
				)
			)
			((or (Said 'clean') (Said 'clean,use/soap'))
				(cond 
					((not (Btst fShowerOn)) (Print 375 4))
					((not (& (ego onControl:) cGREEN)) (Print 375 5))
					((not (ego has: iSoap)) (Print 375 7) (Print 375 8 #at -1 144))
					(else
						(Ok)
						(Bclr fNotShower)
						(Bclr fNotUseSoap)
						...
						(Print 375 10)
						(if (>= filthLevel 3) (Print 375 11))
						(Print 375 12)
					)
				)
			)
			((and (not (ego has: iSoap)) (Said 'get/soap')) (Print 375 13) (Print 375 14 #at -1 144))
			((Said 'look>')
				(cond 
