...
(instance regCasino of Region
	...
	(method (handleEvent event)
		...
		(cond 
			...
			((and debugging (Said 'increase/backstage')) (Printf 417 2 (++ showroomState)))
			((and debugging (Said 'increase/document')) (Printf 417 3 (++ newspaperState)))
			((and debugging (Said 'increase/attorney')) (Printf 417 4 (++ lawyerState)))
			((Said 'look>')
				(cond 
					(
