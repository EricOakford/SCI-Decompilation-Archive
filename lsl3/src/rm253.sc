...
(instance rm253 of Room
	...
	(method (init)
		...
		(if
		(and (ego has: iGrass) (== ((Inventory at: iGrass) view?) 23))
			(Load VIEW 707)
			(Load VIEW 701)
			(Load VIEW 23)
		)
		(if (ego has: iBottleOfWine) (Load VIEW 13))
		(if (not (Btst fCredits253)) (aCredit1 init:) (aCredit2 init:))
		(if
			(or
				(Btst fFlag15)
				(and
...
(instance RoomScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(14
				(soundFX stop:)
				((Inventory at: iBottleOfWine) view: 29)
				(Format ((Inventory at: iBottleOfWine) name?) 253 34)
				(if (not (Btst fFilledBottlwWithWater))
					(Bset fFilledBottlwWithWater)
		...
		(cond 
			...
			(
				...
				(cond 
					((!= currentStatus egoNORMAL) (GoodIdea))
					((not (& (ego onControl:) $0080)) (Print 253 0))
					((not (ego has: iBottleOfWine)) (Print 253 3))
					((!= ((Inventory at: iBottleOfWine) view?) 28) (Print 253 4))
			...
			(
				...
				(cond 
					...
					((not (ego has: iGrass)) (Print 253 6))
					((!= ((Inventory at: iGrass) view?) 23) (Print 253 7))
					((and (< filthLevel 3) (aDoor cel?)) (Print 253 8))
					((== currentStatus egoNATIVE) (self changeState: 17))
			...
			(
				...
				(cond 
					((== currentStatus egoNORMAL) (Print 253 6))
					((& (ego onControl:) $0040) (Print 253 5))
					((not (& (ego onControl:) $0010)) (Print 253 1))
					((!= currentStatus egoNATIVE) (Print 253 9))
					((and (< filthLevel 3) (aDoor cel?)) (Print 253 8))
			...
			((Said 'look>')
				(cond 
					...
					((Said '/door')
						(cond 
							((& (ego onControl:) cRED) (Print 253 24))
							((& (ego onControl:) cBLUE) (Print 253 25))
							((& (ego onControl:) cGREEN) (Print 253 26))
							((& (ego onControl:) cCYAN) (Print 253 27))
							(else (NotClose))
						)
					)
