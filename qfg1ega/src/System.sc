...
;;;	)
	...
	(method (contains anObject)
		...
		;EO: Changed "action" parameter to "doAction" due to the action: selector
		;that is in the Skilled subclass, which confuses the compiler.
