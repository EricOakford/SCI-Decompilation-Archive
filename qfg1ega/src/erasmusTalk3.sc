	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				; One of the more common types is the one that has a strange face popping up every so often.
			)
			(1
				(FenrusPrint 5 134 1)
			...
			(5
				...
				;At any rate, I used to have a nice magic hand mirror, but I misplaced it somewhere. 
				; It could be used to reflect a spell back upon the caster.
			)
			(6
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				;However, in order to be a wizard,
				; you need to have undergone initiation into the "Wizard's Institute of Technocery" in the South.
			)
			(2
