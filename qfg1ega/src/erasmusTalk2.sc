	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				;I thought that "Erasmus' Rootin' Tootin' Root Beer" was a WONDERFUL name for a product! 
				; It's a shame the company went broke after that.
			)
			(6
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				;Erana's spell prevents the use of excessive violence or hostile magic within Spielburg's walls,
				; with the exception of a couple of places.
			)
			(1
				(ErasmusPrint 9 133 6)
				;It looks to me from up here as if she missed the back part of the alley,
				; and the spell applies only to areas in town above the ground.
			)
			(2
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				...
				;So, to break the curse, a hero must get rid of Baba Yaga, in addition to all the other things. 
				; It does not reflect well on Baba Yaga.
			)
			(7
