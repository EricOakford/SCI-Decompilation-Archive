...
(instance rm65 of Room
	...
	(method (dispose)
		...
		(if talkRet (SolvePuzzle f65GotAdviceFromBruno 2)
			(HighPrint 65 0)
		...
		(cond 
			...
			((== (event type?) saidEvent)
				(cond 
					...
					((and (not brunoAttention) (Said 'ask'))
					...
					((Said 'chat,ask>')
						(if gave1Silver
							...
							(if (and (!= silversWanted 20) (not gave1Silver))
								(HighPrint 65 61)
