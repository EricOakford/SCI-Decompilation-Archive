...
(instance rm089 of Rm
	...
	(method (init)
		...
		(if howFast
			...
			(addToPics add: aFlag1 aFlag2 species)
		)
...
(instance RoomScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Print 89 1 #at -1 140 #dispose)
			)
			(3
				(Print 89 2 #at -1 140 #dispose)
			)
			(4
				(Print 89 3 #at -1 140 #dispose)
			)
			(5
				(aBand setLoop: 9 setCel: 0)
				(theSong number: 92 loop: 1 play:)
				(Print 89 4 #at -1 140 #dispose)
			)
			(6
				(Print 89 5 #at -1 140 #dispose)
				(= seconds 2)
			)
			(7
			...
			(8
				(Print 89 6 #at -1 140 #dispose)
				(aAdmiral setLoop: 7 setCel: 0)
				(= seconds 2)
			)
			(9 (ego setLoop: 6 setCel: 2))
			(10
				(ego setCel: 0)
				(Print 89 7 #at -1 140 #dispose)
			)
			(11
				(Print 89 8 #at -1 140 #dispose)
