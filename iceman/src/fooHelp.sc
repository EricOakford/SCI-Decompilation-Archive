...
(instance VanScript of Script
	...
	(method (doit)
		...
		(cond 
			...
			((== (theSong prevSignal?) 15) (theSong prevSignal: 0) (VanScript changeState: 39))
			((== (theSong prevSignal?) 20) (theSong prevSignal: 0) (VanScript changeState: 31))
			...
			((and (< (theVan y?) 36) (!= local1 18)) (= local1 1))
			(
			...
			(and (& (theVan onControl:) $1000) (== local1 0))
				(cond 
					((< (VanScript state?) 11) (= local2 23) (= local3 125))
					((< (VanScript state?) 19) (= local2 29) (= local3 71))
					((< (VanScript state?) 27) (= local2 66) (= local3 29))
				)
				(if (> local0 (Random 4 7))
					(= local1 16)
			...
			((== local1 11) (theSong stop:) (VanScript changeState: 45))
		)
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(theSong number: (SoundFX 69) loop: 1 play:)
				(= cycles 20)
			)
			(1
			...
			(29
				(theSong fade:)
				(theVan setCel: 1)
				(if howFast (= cycles 10) else (= cycles 5))
			)
			(30
				(Print 88 0 #at -1 120 #dispose)
				(theSong number: (SoundFX 79) loop: 1 play:)
				(theProp
					setPri: 14
					view: 488
					setLoop: 1
			...
			(36)
			(37
				(if (< (theVan distanceTo: theJeep) 25) (= local1 11))
				(theVan
					ignoreActors:
					illegalBits: 0
			...
			(38
				(theSong number: (SoundFX 78) loop: 1 play:)
				(switch howFast
					(0 (= local5 20))
					(1 (= local5 15))
					(2 (= local5 10))
			...
			(39
				(ShakeScreen 4 1)
				(cond 
					((== local1 19) (EgoDead 988 0 2 88 3))
					((== local1 17) (EgoDead 988 0 2 88 4))
					(else (= local1 1) (EgoDead 988 0 2 88 5))
				)
			)
			(40
				(if (< (theVan distanceTo: theJeep) 25) (= local1 19))
			...
			(44
				(if (== local1 19) (EgoDead 988 0 1 88 3))
				(if (== local1 16) (EgoDead 988 0 1 88 5))
				(if (== local1 17) (EgoDead 988 0 1 88 6))
			)
			(45
				(= local1 1)
				(theVan setCel: 0 setMotion: 0)
				(theJeep setScript: 0 setMotion: 0 setCel: 0)
				(EgoDead 988 0 0 88 7)
			)
		)
	)
