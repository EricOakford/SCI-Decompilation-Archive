...
(class User of Object
	...
	(method (init param1 param2)
		(= inputLineAddr (if argc param1 else @userInput))
		(= userLen (if (== argc 2) param2 else 45))
	)
	...
	(method (getInput param1 &tmp temp0 temp1)
		(if (!= (param1 type?) 4) (= userInput 0))
		(if (!= (param1 message?) echo)
			(Format @userInput 996 0 (param1 message?))
		)
		(= temp0 (Sound pause: blocks))
		(= temp1 (GetInput @userInput userLen prompt 67 x y))
		(Sound pause: temp0)
		(return temp1)
	)
