...
(procedure (localproc_0909 param1 param2 param3)
	(switch param1
		(1782
...
(instance testRoom of LBRoom
	...
	(method (init)
		...
		(super init:)
		(theIconBar disable:)
		(= theGLb2Messager messager)
		(= messager convMessager)
		(partyLaura addToPic:)
		(switch global128
			(0
				(= local0 13)
...
(instance sConv of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0 (= cycles 2))
			(1
				(messager say: local0 0 0 0 self)
			)
			(2
				(++ global128)
				(curRoom newRoom: (RotundaRgn convRoom?))
			)
		)
	)
)
...
(instance tkrParty1 of Talker
	...
	(method (init)
		...
		(tkrMouth1 view: view)
		(localproc_0909 view tkrEyes1 tkrMouth1)
		(= textX (* (- x 10) -1))
		(= textY (- (WhichLanguage 108 108 108 108 120) y))
		(= font userFont)
...
(instance tkrParty2 of Talker
	...
	(method (init)
		...
		(tkrMouth2 view: view)
		(localproc_0909 view tkrEyes2 tkrMouth2)
		(= textX (* (- x 10) -1))
		(= textY (- (WhichLanguage 108 108 108 108 120) y))
		(= font userFont)
...
(instance tkrParty3 of Talker
	...
	(method (init)
		...
		(tkrMouth3 view: view)
		(localproc_0909 view tkrEyes3 tkrMouth3)
		(= textX (* (- x 10) -1))
		(= textY (- (WhichLanguage 108 108 108 108 120) y))
		(= font userFont)
...
(instance tkrParty4 of Talker
	...
	(method (init)
		...
		(tkrMouth4 view: view)
		(localproc_0909 view tkrEyes4 tkrMouth4)
		(= textX (* (- x 10) -1))
		(= textY (- (WhichLanguage 108 108 108 108 120) y))
		(= font userFont)
...
(instance tkrParty5 of Talker
	...
	(method (init)
		...
		(tkrMouth5 view: view)
		(localproc_0909 view tkrEyes5 tkrMouth5)
		(= textX (* (- x 10) -1))
		(= textY (- (WhichLanguage 108 108 108 108 120) y))
		(= font userFont)
...
(instance Laura of Talker
	...
	(method (init)
		...
		(tkrMouthL view: view)
		(localproc_0909 view tkrEyesL tkrMouthL)
		(= textX 58)
		(= textY (- (WhichLanguage 108 108 108 108 120) y))
		(= font userFont)
