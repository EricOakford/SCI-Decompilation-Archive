...
(define	SHOW_SCROLLS	70)	;SHOW_SCROLL_LEFT SHOW_SCROLL_RIGHT SHOW_SCROLL_UP SHOW_SCROLL_DOWN
(define	SHOW_WIPES		26)	;SHOW_WIPE_LEFT SHOW_WIPE_RIGHT SHOW_WIPE_DOWN SHOW_WIPE_UP
(define	SHOW_DISSOLVES	23)	;SHOW_PIXEL_DISSOLVE SHOW_DISSOLVE)
(define	SHOW_SHUTTERS	10)	;SHOW_HSHUTTER_OUT SHOW_HSHUTTER_IN SHOW_VSHUTTER_OUT SHOW_VSHUTTER_IN)
