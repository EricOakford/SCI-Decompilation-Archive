...
(procedure (proc64014_1 param1 param2 &tmp newStr temp1)
	(= newStr (Str new:))
...
(procedure (proc64014_2 param1 param2 &tmp newStr temp1)
	(= newStr (Str new:))
	(if (> argc 1) (newStr format: {%hu} param2))
	(= temp1
		(if (GetInput newStr 5 param1)
...
(procedure (localproc_00b2 param1 &tmp printInit temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 temp14 temp15 temp16 temp17 temp18 temp19 temp20 temp21 temp22 temp23 temp24 temp25 temp26)
	(if
		(or
			(not param1)
			(not (param1 isKindOf: View))
			(== (param1 view?) -1)
		)
		(return 1)
	)
	...
	(if (= printInit (Print init:))
		...
		(if (param1 isKindOf: Actor)
			(localproc_0921 param1 (temp20 asInteger:))
		)
		(param1
			view: temp9
			setLoop: temp11
		...
		(if (!= temp24 temp25) (param1 setScalePercent: temp24))
	)
	(temp22 dispose:)
	(temp8 dispose:)
	(temp10 dispose:)
...
(procedure (localproc_0719 param1 &tmp temp0)
...
(procedure (localproc_07c4 param1 param2 param3 param4)
	(if
		(and
			(or
				(not theNewActor)
				(not (theNewActor isKindOf: param2))
			)
			(= theNewActor
				(localproc_081f param1 param2 param3 param4)
			)
		)
		(localproc_0719 theNewActor)
	)
	(return theNewActor)
)

(procedure (localproc_081f param1 param2 param3 param4 &tmp temp0 temp1 temp2 temp3 temp4)
	(= temp2 32764)
	(= temp1 0)
	(= temp4 (param1 first:))
	(while temp4
...
(procedure (localproc_08c1 param1 param2 &tmp temp0)
...
(procedure (localproc_0921 param1 param2 &tmp temp0)
	(= temp0 param2)
	(while (> temp0 360)
		(= temp0 (- temp0 360))
	)
...
(procedure (localproc_0978 param1 &tmp temp0 theTheThePlane theThePlane)
	(FrameOut)
...
(procedure (localproc_0a13 &tmp temp0 temp1 temp2)
	(poly_pol name: {msgcheck.txt} open: 2)
	(= temp0 0)
	(= temp1 0)
	(poly_pol
		writeString:
			{Dump of L7 Message Problems\0D\n\0D\nAll Verb Text (1-250):\0D\n}
	)
	(= temp2 1)
	(while (< temp2 250)
		(cond 
		...
		(if temp0 (temp0 dispose:) (= temp0 0))
		(if temp1 (temp1 dispose:) (= temp1 0))
		(++ temp2)
	)
	(poly_pol close:)
)
			...
			(evKEYBOARD
				(switch (event message?)
					...
					(KEY_ALT_d
						...
						(localproc_00b2 printInit)
					)
					(KEY_ALT_e
						(= temp23 (localproc_0978 event))
						(if
						((temp23 getMainCast:) contains: (user alterEgo?))
							(localproc_00b2 (user alterEgo?))
						else
							(Prints {no ego!})
							(return)
						)
					...
					(KEY_ALT_g
						...
						(Print
							font: userFont
							y: 100
							addTextF: {Flag num (max %d)} 35
							addEdit: temp6 5 50
							init:
						)
						(if (>= (= temp4 (temp6 asInteger:)) 35)
					...
					(JOY_LEFT
						(= temp23 (localproc_0978 event))
						(if (and curRoom (curRoom respondsTo: #gimme))
							(curRoom gimme:)
						)
					)
					(KEY_ALT_h
					...
					(KEY_ALT_i
						...
						(repeat
							...
							(while
								(<
									temp19
									(((ScriptID 64037 0) oAllHandledItems?) size:)
								)
								(if
									(not
										(= temp16
											(((ScriptID 64037 0) oAllHandledItems?) at: temp19)
										)
									)
								else
									(breakif (>= temp19 150))
							...
							(ego
								get: (((ScriptID 64037 0) oAllHandledItems?) at: printInit)
							)
						)
						(Print font: userFont)
					)
					(KEY_ALT_j
						...
						(if
							(and
								(!=
									(= temp7 (proc64014_1 {Pic #?} (curRoom picture?)))
									-1
								)
								(ResCheck 129 temp7)
							)
					...
					(KEY_ALT_k
						(= temp23 (localproc_0978 event))
						(if (not theNewActor) (return))
						(localproc_0719 theNewActor)
					)
					(KEY_ALT_l
						((ScriptID 64952 0) doit:)
					)
					(KEY_ALT_m (localproc_0a13))
					(KEY_ALT_p
						(= temp23 (localproc_0978 event))
						(if
							(or
