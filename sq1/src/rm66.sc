...
(local
	blastX
	blastY
	[withGPts 70] = [0 189 0 0 319 0 319 105 292 105 292 94 307 94 307 45 278 45 278 94 289 94 289 105 221 105 221 96 235 96 235 44 204 44 204 96 217 96 217 105 0 104 0 110 13 110 2 119 2 134 128 134 101 147 91 147 33 176 91 176 147 134 169 134 186 142 319 142 319 189]
	[withoutGPts 64] = [0 189 0 0 319 0 319 102 308 105 304 110 286 110 278 105 221 105 221 96 235 96 235 44 204 44 204 96 217 96 217 105 0 104 0 110 13 110 2 119 2 134 128 134 104 149 88 149 39 175 91 175 112 158 144 134 169 134 186 142 319 142 319 189]
)
(instance rm66 of SQRoom
	...
	(method (init)
		...
		(withG points: @withoutGPts size: 32)
		(withoutG points: @withGPts size: 35)
	...
	(method (doit &tmp theControl)
		(cond 
			...
			((& (= theControl (ego onControl: origin)) cCYAN) (self setScript: toLaundry))
			((& theControl cRED) (curRoom newRoom: 61))
		)
		(super doit:)
	)
	...
	(method (dispose)
		...
		(if (standingSarien dead?) (Bset fElevatorGuardDead))
		(super dispose:)
	)
...
(instance toLaundry of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(ego ignoreActors: TRUE setMotion: MoveTo 0 109 self)
			)
...
(instance fromHallwayC of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(ego ignoreActors: TRUE setMotion: MoveTo 90 161 self)
			)
			(1
				(ego ignoreActors: FALSE)
				(HandsOn)
