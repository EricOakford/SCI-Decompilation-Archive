...
(instance rm67 of SQRoom
	...
	(method (init)
		...
		(cond 
			((Btst fPodGone) 0)
			((Btst fLeftDeltaurPodBay) (escapePod init:) (hood init: setCycle: EndLoop self))
	...
	(method (doit)
		(cond 
			((Btst fDeltaurSelfDestructs) (Print 67 0) (curRoom newRoom: 71))
			((ego script?) 0)
			(
				(and
			...
			((and (& (ego onControl: 0) cYELLOW) (Btst fLeftDeltaurPodBay)) (ego setScript: getInLaunchTube))
			(
			(and (& (ego onControl: 0) cYELLOW) (not (ego script?))) (ego setScript: getInEscapePod))
		)
		(super doit: &rest)
	)
...
(instance roomControl of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(cond 
					((Btst fPodGone) (self setScript: noEscapeForEgo))
					((Btst fLeftDeltaurPodBay) (self setScript: waveGoodBye))
...
(instance goingUp of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(if (Btst fStartedSelfDestruct) (Bset fLeftDeltaurPodBay))
				(curRoom newRoom: 66)
			)
		)
	)
