...
(instance rm24 of SQRoom
			...
			(self
				addObstacle:
					((Polygon new:)
						type: PBarredAccess
						init:
							319 127 194 127 136 128 152 115 209 114 272 107
							257 100 224 106 203 105 160 94 129 94 113 94 134 81
							160 81 199 61 277 54 319 76
						yourself:
					)
					((Polygon new:)
						type: PBarredAccess
			...
			(self
				addObstacle:
					((Polygon new:)
						type: PBarredAccess
						init:
							93 189 86 173 61 148 50 130 58 128 53 121
							37 120 14 99 13 88 0 76 0 0 318 0 319 189
						yourself:
					)
					((Polygon new:)
						type: PBarredAccess
	...
	(method (doit)
		(cond 
			(script 0)
			((& (ego onControl: origin) cYELLOW) (self newRoom: 28))
		)
		(super doit:)
	)
)
