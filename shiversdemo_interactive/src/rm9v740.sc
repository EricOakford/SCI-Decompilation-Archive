...
(instance rm9v740 of ShiversRoom
	...
	(method (newRoom n)
		(if (and (proc951_5 42) (< 9000 n) (< n 9200))
...
(instance efLeftForward of ExitFeature
	...
	(method (init)
		(self
			createPoly: 84 82 93 60 100 60 100 41 30 41 21 42 21 94 81 94
		)
		(super init: &rest)
	)
)
...
(instance efRightForward of ExitFeature
	...
	(method (init)
		(self
			createPoly: 201 94 199 72 203 28 243 28 243 106 204 105
		)
		(super init: &rest)
	)
)
...
(instance efGlass of ExitFeature
	...
	(method (init)
		(self
			createPoly: 190 76 165 71 158 27 197 27 203 31 199 69
		)
		(super init: &rest)
	)
)
