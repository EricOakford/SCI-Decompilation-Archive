...
(instance introMovie of ShiversRoom
	...
	(method (init &tmp temp0 temp1 temp2)
		...
		(if (proc951_5 39)
			...
			((= local0
				((VmdMovie new:) open: 1002 client: self yourself:)
			)
				caller: self
			)
			(if (proc951_5 38)
							...
							(if (== (local0 setWaitEvent: 23 360) 1)
								...
								(if (== (local0 setWaitEvent: 23 445) 1)
									...
									(if (== (local0 setWaitEvent: 23 495) 1)
										(= temp2
											(Str
												format: { Right, the police never found the bodies...or the killer.}
											)
										)
										(self drawText: temp2 0 18)
										(temp2 data: 0 dispose:)
										(if (== (local0 setWaitEvent: 23 530) 1)
											...
											(self drawText: temp2 0 18)
											(temp2 data: 0 dispose:)
											(if (== (local0 setWaitEvent: 23 675) 1)
												(= temp2
													(Str
														format:
												...
												(self drawText: temp2 0 18)
												(temp2 data: 0 dispose:)
												(if (== (local0 setWaitEvent: 23 750) 1)
													(= temp2
														(Str
															format:
													...
													(self drawText: temp2 0 18)
													(temp2 data: 0 dispose:)
													(if (== (local0 setWaitEvent: 23 850) 1)
														(= temp2
															(Str
																format:
														...
														(self drawText: temp2 0 18)
														(temp2 data: 0 dispose:)
														(if (== (local0 setWaitEvent: 23 890) 1)
															(= temp2
																(Str
																	format:
															...
															(self drawText: temp2 0 18)
															(temp2 data: 0 dispose:)
															(if (== (local0 setWaitEvent: 23 950) 1)
																(= temp2
																	(Str
																		format:
																...
																(self drawText: temp2 0 18)
																(temp2 data: 0 dispose:)
																(if (== (local0 setWaitEvent: 23 990) 1)
																	(= temp2
																		(Str
																			format:
																	...
																	(self drawText: temp2 0 18)
																	(temp2 data: 0 dispose:)
																	(if (== (local0 setWaitEvent: 23 1030) 1)
																		(= temp2
																			(Str
																				format:
																		...
																		(self drawText: temp2 0 18)
																		(temp2 data: 0 dispose:)
																		(if (== (local0 setWaitEvent: 23 1100) 1)
																			(self eraseText:)
																			(== (local0 setWaitEvent: 23 1252) 1)
																		)
																	)
																)
															)
		...
		(cond 
			...
			((== global186 1) (curRoom newRoom: 6220))
			(else (curRoom newRoom: 1012))
		)
	)
