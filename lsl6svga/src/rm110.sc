...
(instance cartoonScr of Script
	...
	(method (changeState newState &tmp temp0 temp1)
		(switch (= state newState)
			...
			(3)
			(4
				(SetScroll thePlane 0 -20 111 0 1 0)
			...
			(24
				...
				(SetScroll thePlane 0 -20 112 0 0 0)
				(= temp1 (ByteArray new: 30))
				(Message 0 110 0 0 1 1 (temp1 data?))
				(proc79_4 (temp1 data?) 75 0 100 160 318 900)
				(temp1 dispose:)
				(= seconds 6)
				(= register 100)
			)
			(25 (proc79_5) (= cycles 2))
			(26
				(if (> (= register (- register 4)) -1)
					(-- state)
				...
				(if (> howFast 3) (= ticks 4) else (= ticks 2))
			)
			(27
				(Palette 2 0 255 0)
				(curRoom newRoom: 120)
