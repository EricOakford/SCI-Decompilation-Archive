...
;SCICompanion does not yet support non-integer defines. Will uncomment these once it does.
...
;NOTE: No non-integer define support in SCICompanion (yet)
...
(define	mouseUp		$0002)
(define mouseEvt	$0003)	;(define	mouseEvt		(| mouseDown mouseUp))

(define	keyDown		$0004)
(define	keyUp		$0008)
(define keyEvt		$0012)	;(define	keyEvt		(| keyDown keyUp))

(define	direction	$0010)

(define	joyDown		$0020)
(define	joyUp		$0040)
(define joyEvt		$0060)	;(define	joyEvt		(| joyDown joyUp))
