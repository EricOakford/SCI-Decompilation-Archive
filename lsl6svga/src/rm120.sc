...
(procedure (localproc_003a param1 &tmp temp0 temp1 temp2)
	(if (== param1 2)
		(= temp0 315)
		(= temp1 175)
		(= temp2 1)
...
(instance creditScr of Script
	...
	(method (dispose &tmp temp0)
		...
		(cond 
			((== state 89)
				(= temp0 1)
				(while (<= temp0 8)
					(if ([newMyPrint temp0] dialog?)
						(([newMyPrint temp0] dialog?) dispose:)
						(= [newMyPrint temp0] 0)
					)
					(++ temp0)
				)
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(1
				(if (>= (= register (+ register 2)) 100)
					(-- state)
					(Palette 2 0 255 register)
				)
				(= ticks 1)
			)
			(2
			...
			(10
				...
				(proc79_12 123)
				(Load rsVIEW 951)
				(if (> howFast 3) (= seconds 4) else (= seconds 2))
			)
			(11
				(c1 setCel: 0 view: 98)
				(c2 setCel: 0 view: 98)
			...
			(24
				...
				(if (> howFast 3) (= seconds 5) else (= seconds 3))
			)
			(25
				(sfx number: 0 stop:)
				(proc79_12 800)
			...
			(89
				...
				(while (<= temp0 8)
					...
					(= [newMyPrint temp0] (myPrint new:))
					(Message 0 110 0 0 3 temp0 ([local2 temp0] data?))
					([newMyPrint temp0]
						fore: 1
						back: -1
						font: 900
			...
			(91
				...
				(while (<= temp0 8)
					(= [local2 temp0] (ByteArray new: 30))
					(= [newMyPrint temp0] (myPrint new:))
					(Message 0 110 0 0 4 temp0 ([local2 temp0] data?))
					([newMyPrint temp0]
						fore: 1
						back: -1
						font: 900
