...
(class TheMenuBar of MenuBar
	...
	(method (handleEvent event &tmp oldPause i [str 201])
		(switch (super handleEvent: event (User blocks?))
			...
			(bossI
				...
				(Print
					(Format @str
						{In fact, you don't want your boss to know that you've been playing Astro Chicken for %d hours, %d minutes and %d seconds.}
