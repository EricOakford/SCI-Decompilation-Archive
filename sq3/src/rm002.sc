		...
		(switch (event type?)
			(saidEvent
				(cond 
					...
					((Said 'look>')
						(cond 
							((Said '<in,through/craft,pod,pane[<escape]') (Print 2 1))
							((Said '/pane') (Print 2 2))
							((Said '/door,door') (Print 2 3))
							((Said '/nozzle') (Print 2 4))
							((Said '/craft,pod[<escape]') (Print 2 5))
							((Said '[<at,around,in][/area,!*]') (Print 2 6))
						)
					)
					((Said 'smell[/area,air]') (Print 2 7))
					((Said 'fix,open,pry/craft,pod,door[<escape]') (Print 2 8))
					(
					(Said 'hoist,manipulate,press,drag/craft,pod[<escape]') (Print 2 9))
					((Said 'begin/pod,craft,engine') (Print 2 10))
					((Said 'break/pane,glass') (Print 2 11))
					((Said 'climb/craft,pod[<escape]') (Print 2 12))
					((Said 'climb') (Print 2 13))
					(
						(or
							(Said 'climb,get<in,in/craft,pod[<escape]')
							(Said 'enter,board[/craft,pod[<escape]]')
						)
						(Print 2 14)
					)
					((Said 'qa')
